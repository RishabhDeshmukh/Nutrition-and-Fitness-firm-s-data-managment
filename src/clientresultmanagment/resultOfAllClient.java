 ...
 * @author risha
 */
public class resultOfAllClient extends javax.swing.JFrame {

    /**
     * Creates new form resultOfAllClient
     */
    public resultOfAllClient() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        resultOfAllClientButton.setBackground(new java.awt.Color(255, 0, 51));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(resultOfAllClient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
